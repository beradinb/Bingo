        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="float-right">
                    <a href="{{ route("backend.slot.$module_name.create") }}" class="btn btn-success m-1 btn-sm" data-toggle="tooltip" title="Create New"><i class="fas fa-plus-circle"></i> Create</a>
...
<script type="text/javascript">
    ...
    $('#datatable').DataTable({
        ...
        autoWidth: true,
        responsive: true,
        ajax: '{{ route("backend.bingo.$module_name.index_data") }}',
        columns: [
            {data: 'id', name: 'id'},
